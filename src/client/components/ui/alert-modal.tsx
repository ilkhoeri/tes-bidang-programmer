  ...
  return (
    <Dialog open={isOpen} onOpenChange={onChange}>
      <DialogContent
        ...
        className={twMerge('[--ring-focus:#b91c1c]', classNames?.content)}
      >
        <DialogHeader className={classNames?.header}>
          {icon}
          <div className={twMerge('grid', classNames?.headerWrap)}>
            <DialogTitle
              className={twMerge('text-[#b91c1c]', classNames?.title)}
            >
              {title}
            </DialogTitle>
        ...
        <div className={classNames?.body}>
          ...
          <DialogFooter className="pt-6 gap-2 flex-row justify-end w-full">
            ...
            <Button
              ...
              disabled={disabled}
              onClick={onConfirm}
              className="min-w-[96px] w-[96px] bg-red-500 text-red-50"
            >
              Delete
            </Button>
          </DialogFooter>
